        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-brand">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="addBrand.php">Add Brands</a></li>
                <li class="nav-item"> <a class="nav-link" href="viewBrand.php">View Brands</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-user">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="addUser.php">Add Role</a></li>
                <li class="nav-item"> <a class="nav-link" href="viewUser.php">View Role</a></li>
              </ul>
            </div>
          </li>
